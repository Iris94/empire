...
const AboutBackground = () => {
    ...
    return (
        <div className='w-full h-3/6 flex blue-card p-2'>
           {playerClass === 'Knight' ? <p className='text-white dark-blue-card text-sm'>
           ...
           {playerClass === 'Mage' ? <p className='text-white dark-blue-card text-sm'>
           ...
           {playerClass === 'Assassin' ? <p className='text-white dark-blue-card text-sm'>
